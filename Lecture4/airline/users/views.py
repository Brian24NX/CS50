...
def login_view(request):
    if request.method == "POST":
        username = request.POST["username"] # Accessing username and password from form data
        password = request.POST["password"] # Accessing username and password from form data
